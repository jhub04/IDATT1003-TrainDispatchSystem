 ...
 * This class acts as a model for a single train departure.
 * It stores the departure time, line, train number, destination, track and delay of a train
 *
 * <p>Data and Data Types:</p>
 * - departureTime (Localtime): The departure time for the train.
 * - line (String): The line the train is on.
 * - trainNumber (int): The train number.
 * - destination (String): The destination of the train.
 * - track (String): The track the train departs from.
 * - delay (LocalTime): The delay of the train, if any.
 *
 ...
 * without a date.
 * - line: String is suitable for general text.
 * - trainNumber: int is suitable for this number.
 * - destination: String is suitable for general text.
 * - track: int is suitable for this number.
 * - delay: Chose LocalTime so that it is easy to add to the departure time.
 *
