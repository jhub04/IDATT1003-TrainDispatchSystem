...
public class TrainDepartureRegister {
  ...
  public void removeDeparture(int trainNumber) {
    try {
      ...
      persistence.removeDepartureFromCsv(trainNumber);
    } catch (IOException e) {
      System.out.println(ERROR + e.getMessage());
    }
  }
    ...
    for (TrainDeparture departure : register) {
      if (departure.getTrainNumber() == trainNumber) {
        try {
          ...
          persistence.updateDepartureToCsv(departure);
          return;
        } catch (IOException e) {
  ...
  public void readData() {
    try {
      this.register.clear();
      this.register = persistence.readCsv(register);
    } catch (IOException e) {
      System.out.println(ERROR + e.getMessage());
    }
  }
  ...
  public boolean trainNumberExistsInPerm(int trainNumber) {
    try {
      if (persistence.trainNumberExistsInCsv(trainNumber)) {
        return true;
      }
    } catch (IOException e) {
      System.out.println(ERROR + e.getMessage());
  ...
  private void writeDepartureToPerm(TrainDeparture departure) {
    try {
      persistence.writeDepartureToCsv(departure);
    } catch (IOException e) {
      System.out.println(ERROR + e.getMessage());
    }
  }
